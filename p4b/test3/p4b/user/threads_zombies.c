...
func(void *arg1, void *arg2)
{
  ...
  printf(1, "func_1 ppid = %d, pid = %d, lastpid = %d\n", ppid, pid, lastpid);
  ...
  printf(1, "func_2 ppid = %d, pid = %d, lastpid = %d\n", ppid, pid, lastpid);
  exit();
...
main(int argc, char *argv[])
{
  ...
  if (pid > 0) {
    ...
    printf(1, "Parent process call wait()\n");
    pid = wait();
    printf(1, "Parent process wait end\n");
